...
import { getUsers, getProjects, createInvoice } from '@/lib/firebase/database';
...
import type { User, Project } from '@/lib/db/types';
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">Issue a new invoice to a client</p>
                    </div>
                </div>
