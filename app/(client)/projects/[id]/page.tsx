          ...
          <Card className="bg-primary/5">
            ...
            <CardContent className="space-y-6">
              <div className="space-y-3">
                ...
                <p className="text-[10px] text-muted-foreground uppercase font-semibold text-center tracking-tight">Deployment Progress tracked by BridgeBreak</p>
              </div>
              <Separator />
              <div className="flex items-center gap-3">
                  ...
                  <div className="space-y-4">
                    {project.notes.map((note, i) => (
                      <div key={i} className="flex gap-4 items-start border-l-2 border-primary/20 pl-4 py-1">
                        <p className="text-sm text-muted-foreground italic leading-relaxed">"{note}"</p>
                      </div>
                    ))}
                  </div>
                )}
